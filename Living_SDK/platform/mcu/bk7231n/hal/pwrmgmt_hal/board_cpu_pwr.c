...
static int dtim_enable_flag;
static int mcu_enable_flag;
/**
...
int pwrmgmt_suspend_lowpower(void)
{
	...
	mcu_enable_flag = bk_wlan_mcu_ps_get_enable_flag();
	if(mcu_enable_flag)
	{
	...
	dtim_enable_flag = bk_wlan_dtim_rf_ps_get_enable_flag();
	if(dtim_enable_flag)
	{
