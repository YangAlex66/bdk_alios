...
function files_cp()
{
	...
	cp Living_SDK/out/$2@$3/libraries/board_bk7231n.a prebuild/lib/board_bk7231ndevkitc.a
	if [ -f Living_SDK/platform/mcu/bk7231n/beken/beken.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/beken.a prebuild/lib/
	fi
	if [ -f Living_SDK/platform/mcu/bk7231n/beken/ip/ip.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/ip/ip.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/func/rf_use/rf_use.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/func/rf_use/rf_use.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/func/rf_test/rf_test.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/func/rf_test/rf_test.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/func/uart_debug/uart_debug.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/func/uart_debug/uart_debug.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/func/bk7011_cal/bk7011_cal.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/func/bk7011_cal/bk7011_cal.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/func/wpa_supplicant_2_9/wpa_supplicant_2_9.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/func/wpa_supplicant_2_9/wpa_supplicant_2_9.a prebuild/lib/
	fi

	if [ -f Living_SDK/platform/mcu/bk7231n/beken/driver/ble_5_x_rw/ble.a ]; then
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/ble_5_x_rw/ble.a prebuild/lib/
	fi
	cp Living_SDK/platform/mcu/bk7231n/bk7231n.ld prebuild/lib/bk7231n.ld.S
	#cp Living_SDK/platform/mcu/bk7231n/beken/alios/entry/entry.a  prebuild/lib/
	...
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/include/ble_api.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/include/ble_api_5_x.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/ble_5_x_rw/ble_pub/app/api/app_ble_init.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/common/typedef.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/config/sys_config.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/alios/lwip-2.0.2/apps/include/*.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/func/include/wlan_ui_pub.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/common/*.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/config/sys_config.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/driver/common/compiler.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/release/*.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/alios/entry/*.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/ip/common/co_int.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/alios/os/include/rtos_pub.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/func/include/rw_msg_pub.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/func/include/wlan_defs_pub.h prebuild/include
	cp Living_SDK/platform/mcu/bk7231n/beken/func/include/notifier_pub.h prebuild/include
	fi
	if [[ "$2" == irda_demo ]];then
	cp Living_SDK/platform/mcu/bk7231n/hal/irda.h Living_SDK/include/hal/soc
	fi
...
function build_bin()
{
	...
	./tools/cmd/linux64/awk '{ gsub("'INCLUDE\ \board/bk7231ndevkitc/bk7231ndevkitc.ld'","INCLUDE Living_SDK/board/bk7231ndevkitc/bk7231ndevkitc.ld"); print $0 }' $p/bk7231n.ld.S > $p/bk7231n.ld
	...
	if [[ "$CHIP"  == "bk7231n" ]]; then
		./tools/bk7231n/encrypt_linux $OUT/$2@$3.bin 0 0 0 0
	...
	cp Living_SDK/platform/mcu/bk7231n/bootloader_bk7231n_uart0_v1.0.8.bin $OUT/bootloader_bk7231n.bin
	/usr/bin/python tools/bk7231n/gen_firmware_img.py $OUT/$2@$3_crc.bin $OUT/bootloader_bk7231n.bin
...
if [ ! -d Living_SDK/example/$2 ] || [ ! -d Living_SDK/out/$2@$3 ]; then
	...
	if [ -d Living_SDK/example ]; then
		...
		if [[ -s Living_SDK/diff.txt ]] || [[ ! -f prebuild/lib/board_bk7231n.a ]]; then
