...
function files_cp()
{
	...
	if [ -f Living_SDK/platform/mcu/bk7231u/beken/driver/ble/ble.a ]; then
...
function build_bin()
{
	...
	cp Living_SDK/platform/mcu/bk7231u/bootloader_bk7231u_uart1_v1.0.8.bin $OUT/bootloader_bk7231u.bin
