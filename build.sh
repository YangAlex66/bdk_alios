...
if [[ "${board}" == "hf-lpb130" ]] || [[ "${board}" == "hf-lpb135" ]] || [[ "${board}" == "hf-lpt230" ]] || [[ "${board}" == "hf-lpt130" ]] || [[ "${board}" == "uno-91h" ]]; then
	...
	./Living_SDK/platform/mcu/bk7231u/gen_sys_config.sh "bk7231u"
	./tools/bk7231udevkitc.sh  $type $app ${board} ${REGION} ${ENV} ${CONFIG_DEBUG} "${ARGS}"
elif [[ "${board}" == "bk7231ndevkitc" ]]; then
	./Living_SDK/platform/mcu/bk7231n/gen_sys_config.sh "bk7231n"
	./tools/bk7231ndevkitc.sh  $type $app ${board} ${REGION} ${ENV} ${CONFIG_DEBUG} "${ARGS}"
